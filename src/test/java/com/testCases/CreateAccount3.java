...
public class CreateAccount3 extends BaseTest{
	
	public String TestCaseName="CreateInValidCustomerIDTC3";
	
	/*Validate Invalid test cases
	 * Pass the username,blank password and correct email id 
